...
Therefore, a recent trend in urban planning is accessibility-based planning \shortcite{proffittAccessibilityPlanningAmerican2019, geursAccessibilityEvaluationLanduse2004a}.
...
A modern way of measuring accessibility is to use the X-minute city metric, which is inspired by the 15-minute city concept, which recently gained traction during the COVID pandemic \shortcite{morenoIntroducing15MinuteCity2021}.
