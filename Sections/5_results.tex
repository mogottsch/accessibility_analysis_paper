...
Looking at the maximum values reach by each sustainable mode of transport tells us that bicycles are used for no more than 15 minutes, as a 15-minute ride costs \euro{1}.
Next, the long distance ticket of public transport (more than four stops) is used.
Also, in the combined scenario, the long distance ticket of public transport is used together with a 15-minute ride of bicycle sharing, in at least one sub scenario, resulting in the maximum price of \euro{3.95}.
