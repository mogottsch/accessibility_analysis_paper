...
For bicycle sharing, we use the pricing scheme of NextBike, which is 1\euro every 15 minutes.
...
For public transport, we use the pricing scheme of the Cologne Transport Authority (KVB), which is 2.20\euro for trips that span four stops or less.
For any trip that spans more than four stops or any multitude of trips the KVB charges 3.20\euro.
